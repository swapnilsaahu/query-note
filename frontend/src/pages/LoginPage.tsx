    ...
    return (
        < div className="min-h-screen w-full px-4 py-6 flex justify-center items-center bg-lavender-grey-900 text-lavender-grey-200 overflow-x-hidden" >
            <div className="w-full max-w-md flex flex-col gap-4 ">
                ...
                <button className="text-lavender-grey-100 bg-lavender-grey-950 py-3 rounded-xl w-full hover:bg-lavender-grey-700" onClick={() => { loginHandle(); setError(false) }}>{signInloading ?
                    <BeatLoader />
                    : "Login"}</button>
